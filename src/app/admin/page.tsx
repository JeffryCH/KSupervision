        ...
        <div className="container">
          <section className="admin-dashboard-hero mb-5">
            ...
            <p className="lead text-muted mb-4">
              ...
              Desde aquí puedes acceder al panel de módulos, gestionar usuarios
              y revisar configuraciones clave.
            </p>
          ...
          <section className="row g-4" aria-label="Información general">
            ...
            <div className="col-md-6">
              <div className="admin-module-card h-100">
                ...
                <p className="mb-3">
                  El equipo está trabajando en reportes avanzados y supervisión
                  en tiempo real. Encontrarás notificaciones dentro del panel
                  cuando cada módulo esté listo.
                </p>
                <Link
                  href="/admin/panel"
